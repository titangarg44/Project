...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-8" style="border-radius: 25px; border:2px solid black; padding:5px; text-align:center; color:#4A3D3D;">
            <h1 style="font-family: 'Cormorant Garamond', serif;">Admission Form 2023</h1>
        </div>
        <div class="col-sm-2"></div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-10" style="padding: 80px;">
            <form action="admission_form_action.php" method="POST" enctype="mutlipart/form-data">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-3 row">
                            <div class="col-sm-4">
